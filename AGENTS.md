...
2. `claude/START_HERE.md`、`claude/CONTEXT.md`、`claude/handoffs/ACTIVE.md`を順に読む。
...
- 現在地は`claude/CONTEXT.md`、次の担当への指示は`claude/handoffs/ACTIVE.md`、根拠は`claude/reports/`、過去の会話履歴は`claude/chats/`に置く。
