...
**`handoffs/active/2026-09-23_d10-13c_直立ゲート.md`**
...
1. **D10-13C（`procedures/d10_13c_直立ゲート_実験手順.md`）: 直立を確かめてから方策に渡し、方策に任せて床で立つ → vx 0.2 → vx 0.4（要承認）。** 歩けたら D10-14（長く・速く・手を外す）→ D10-15（wz・vy）→ D11（無線コントローラー・Jetson）→ 紐なし。立てなければ D10-12 → D10-11。電源の電流を実測する。
...
| 項目 | 読むファイル |
|---|---|
| 次の作業（引き継ぎ書） | `handoffs/active/2026-09-23_d10-13c_直立ゲート.md` |
| その実行手順 | `procedures/d10_13c_直立ゲート_実験手順.md` |
