...
>
> コントローラーの詳しい設計は `controller_prep_briefing.md`、GPU側の判断規則は `next_chat_briefing.md` を正本とする。この文書は今日の実行順だけを持つ。
...
- GPU温度、VRAM、学習・評価プロセスを確認する。新規学習は、夜間の報告と `next_chat_briefing.md` の規則を確認するまで始めない。
