...
> **2026-09-22更新:** 0x1Cは方策ランプで最大|電流|0.88Aまで出ても追従0.000degだった。同じ方策ランプ・static probeは保留し、次の実機実験をこの手順から開始しない。最新の判断は`chats/2026-09-22_d9-one-axis-ramp-handoff.md`を読むこと。
