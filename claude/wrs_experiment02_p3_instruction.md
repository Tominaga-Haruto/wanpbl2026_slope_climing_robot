...
> 作成 2026-09-16 13:30。`wrs_experiment02_instruction.md` の P3 を**差し替える**。停止点1の報告（C_flatonly が 2400 で歩いた、rel_heading_envs の件、action 0 で前に倒れる）を受けて改訂。
> 根拠は `crab_standstill_countermeasures.md` §5。
